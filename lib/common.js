...
const OPCODES = Enum('inew', 'iinc', 'ishl', 'iadd', 'ineg', 'isht', 'itof', 'itou', 'finf', 'fnan', 'fneg', 'snew', 'sadd', 'onew', 'oadd', 'anew', 'aadd', 'bnew', 'bneg', 'nnew', 'gdup', 'gpop', 'gswp', // custom opcodes
'fnew', 'finc', 'fshl', 'fadd', 'fsht', 'sadf');
const COPCODE_MAP = {
